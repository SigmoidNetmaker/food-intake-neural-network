% FoodIntakefit
% this function provides an error function
% to set initial receptor strengths for FoodIntake
% such that acute effects of drugs match TTA

function error = FoodIntakeFitV2v2(x)
...
BL2= [AgRP.Res  POMC.Res NOSGABAergic.Res OXT.Res  MCH.Res Ntsn.Res LHGal.Res OX.Res NTSCA.Res NTSGLP1.Res VTA.Res NAc.Res FoodIntake];
...
error
% display actual output percentages and error
%[actOutS spacerS TTSout spacerS]
